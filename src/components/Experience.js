                ...
                <Row className="border-bottom pt-3" key={id}>
                  <Col md={10} className="d-flex justify-content-start">
                    ...
                    <div className="px-3">
                      ...
                      <p className="text-muted m-0">{item.company} {item.type} • {item.startMonth} {item.startYear} {`${item.isWorking ? " - Present" : " - "+item.endMonth+" "+item.endYear }`}</p>
        ...
        <Modal.Body>
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            {/* <Form.Group className="mb-3">
              ...
              <Form.Control required  size="sm" placeholder="Ex:Full Time" name="type" value={form.type} onChange={handleForm} />
